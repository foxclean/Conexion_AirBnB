...
URL_1 = 'https://www.airbnb.es'

driver.get(URL_1)
innerHTML = driver.execute_script("return document.body.innerHTML")

LogIn = driver.find_element_by_link_text('Inicia sesión')
LogIn.click()
time.sleep(15)
# find the element that's name attribute is q (the google search box)
inputMail = driver.find_element_by_id("email-login-email")
inputPass = driver.find_element_by_id("email-login-password")

# type in the search
inputMail.send_keys("admin@aparsol.com")
inputPass.send_keys("Madridhaha2020")
